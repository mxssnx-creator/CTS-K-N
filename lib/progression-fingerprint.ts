...
export const progressionFingerprintFields = [
  ...
  "normalEnabled", "variantTrailingEnabled", "variantBlockEnabled", "variantBlockOnly", "blockOnly", "variantDcaEnabled",
  ...
  "blockRowLiveEnabled", "blockRowLiveVolumeRatio", "blockRowLiveProfitFactorRatio", "blockRowLiveMaxStack", "blockRowLivePauseCountRatio",
