...
// PositionCost-relative PF coordinate: 1.00 is neutral. The systemwide stage
// default was raised to 1.30 on 2026-09-16; this CJS copy mirrors
// MAIN_TRADE_DOWNSTREAM_PF_RATIO_DEFAULT and must be kept in step with it.
// Historic note: 1.10 was the
// canonical minimum (one average PositionCost above neutral).
const DIRECT_TRADE_FULL_HISTORY_PF_DEFAULT = 1.3
const DIRECT_TRADE_RECENT_PF_DEFAULT = 1.3
