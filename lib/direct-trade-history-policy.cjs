...
// PositionCost-relative PF coordinate: 1.00 is neutral and 1.10 is the
// canonical minimum (one average PositionCost above neutral).
const DIRECT_TRADE_FULL_HISTORY_PF_DEFAULT = 1.1
const DIRECT_TRADE_RECENT_PF_DEFAULT = 1.1
