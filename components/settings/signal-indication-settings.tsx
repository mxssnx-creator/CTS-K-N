    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription className="text-xs">
            Source and source × symbol × Long/Short windows are stored separately as diagnostics.
            Admission is owned only by the exact source × symbol × direction × config lane.
          </CardDescription>
        </CardHeader>
        <CardContent>
