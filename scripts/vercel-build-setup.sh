...
[[ "$LATEST_MIGRATION" == "88" && "$SEQUENTIAL" == "true" ]] \
  || fatal "Migration bundle is not the expected sequential schema v88: $MIGRATION_REPORT"
log "Sequential schema v88 migration bundle verified"
