...
[[ "$LATEST_MIGRATION" == "84" && "$SEQUENTIAL" == "true" ]] \
  || fatal "Migration bundle is not the expected sequential schema v84: $MIGRATION_REPORT"
log "Sequential schema v84 migration bundle verified"
