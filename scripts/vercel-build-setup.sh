...
[[ "$LATEST_MIGRATION" == "97" && "$SEQUENTIAL" == "true" ]] \
  || fatal "Migration bundle is not the expected sequential schema v97: $MIGRATION_REPORT"

log "Sequential schema v97 migration bundle verified"
