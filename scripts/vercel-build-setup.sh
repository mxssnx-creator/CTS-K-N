...
[[ "$LATEST_MIGRATION" == "89" && "$SEQUENTIAL" == "true" ]] \
  || fatal "Migration bundle is not the expected sequential schema v89: $MIGRATION_REPORT"
log "Sequential schema v89 migration bundle verified"
