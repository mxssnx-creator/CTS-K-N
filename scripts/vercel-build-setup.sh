...
[[ "$LATEST_MIGRATION" == "102" && "$SEQUENTIAL" == "true" ]] \
  || fatal "Migration bundle is not the expected sequential schema v102: $MIGRATION_REPORT"

log "Sequential schema v102 migration bundle verified"
