...
[[ "$LATEST_MIGRATION" == "96" && "$SEQUENTIAL" == "true" ]] \
  || fatal "Migration bundle is not the expected sequential schema v96: $MIGRATION_REPORT"

log "Sequential schema v96 migration bundle verified"
