...
[[ "$LATEST_MIGRATION" == "98" && "$SEQUENTIAL" == "true" ]] \
  || fatal "Migration bundle is not the expected sequential schema v98: $MIGRATION_REPORT"

log "Sequential schema v98 migration bundle verified"
