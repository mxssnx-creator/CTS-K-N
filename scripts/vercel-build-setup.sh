...
[[ "$LATEST_MIGRATION" == "99" && "$SEQUENTIAL" == "true" ]] \
  || fatal "Migration bundle is not the expected sequential schema v99: $MIGRATION_REPORT"

log "Sequential schema v99 migration bundle verified"
