...
[[ "$LATEST_MIGRATION" == "90" && "$SEQUENTIAL" == "true" ]] \
  || fatal "Migration bundle is not the expected sequential schema v90: $MIGRATION_REPORT"
log "Sequential schema v90 migration bundle verified"
