...
**Offen:** Zwei ATOM-Zeilen `pending` mit executedQuantity 0 (18:36 UTC) — nach Deploy prüfen, ob der Stuck-Placement-Sweeper sie schließt; sonst gezielt reconcilen. Realtime-Progression-Budget; Reset-DB prozessübergreifend; geteiltes X02-Konto (CTS-G) — der Halt hebt sich nur in Momenten leerer Fremdbücher auf, dann handelt CTS-K-N live; eigener API-Key bleibt empfohlen.
