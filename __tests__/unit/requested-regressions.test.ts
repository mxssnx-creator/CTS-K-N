Warning: truncated output (original token count: 37887)
Total output lines: 2694
...
describe("requested regression guardrails", () => {
  ...
  test("settings recoordinator uses operator intent and unblocks live trade after credentials save", () => {
    ...
    expect(source).toContain("operator_int…7887 tokens truncated…ect(source).toContain('client.set(`strategies:${this.connectionId}:real:evaluated`, String(realTotalEvaluated))')
