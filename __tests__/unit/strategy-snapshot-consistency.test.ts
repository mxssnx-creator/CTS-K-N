...
describe("coherent strategy snapshots and schema v91", () => {
  ...
  test("migrations are sequential through the coherent schema", () => {
    ...
    expect(source).toContain('name: "091-unlimited-stage-rows-and-block-work-scheduler"')
