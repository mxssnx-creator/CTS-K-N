...
function serializePresetType(presetTypeId: string, stored: RedisHash) {
  return {
    ...
    normal_enabled: stored.normal_enabled === undefined ? true : toBoolean(stored.normal_enabled),
    trailing_enabled: stored.trailing_enabled === undefined ? true : toBoolean(stored.trailing_enabled),
