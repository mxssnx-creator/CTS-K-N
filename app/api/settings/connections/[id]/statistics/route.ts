...
export async function GET(
  ...
  try {
    ...
    const tradingMetrics = {
      ...
      positions_data_available: execution.positionsDataAvailable,
      orders_data_available: execution.ordersDataAvailable,
      positions_snapshot_error: execution.positionsSnapshotError,
      orders_snapshot_error: execution.ordersSnapshotError,
