...
function toLivePositionView(pos: any): Record<string, unknown> {
  ...
  const view: Record<string, unknown> = {
    ...
    volumeKind: pos.volumeKind,
    lotSize: pos.lotSize,
    quoteToUsdRate: pos.quoteToUsdRate ?? pos.quote_to_usd_rate,
    quoteBid: pos.quoteBid,
    quoteAsk: pos.quoteAsk,
    spreadPrice: pos.spreadPrice,
    spreadPips: pos.spreadPips,
    spreadBps: pos.spreadBps,
    spreadPercent: pos.spreadPercent,
    spreadSource: pos.spreadSource,
    quoteTimestamp: pos.quoteTimestamp,
    volumeUsd: pos.volumeUsd,
    lifetimeVolumeUsd: pos.lifetimeVolumeUsd ?? pos.lifetime_volume_usd,
    ...
    positionCostPercent: pos.positionCostPercent ?? pos.position_cost_percent ?? pos.positionCostPct,
    configuredPositionCostPct: pos.configuredPositionCostPct ?? pos.configured_position_cost_pct,
    spreadBufferPips: pos.spreadBufferPips ?? pos.spread_buffer_pips,
    spreadMultiplier: pos.spreadMultiplier ?? pos.spread_multiplier,
    ...
    dcaTakeProfitPrice: pos.dcaTakeProfitPrice,
    securityStopPrice: pos.securityStopPrice,
    ...
    securityStopOrderId: pos.securityStopOrderId,
    ...
    securityStopArmedQuantity: pos.securityStopArmedQuantity,
    stopLossLastArmedAt: pos.stopLossLastArmedAt,
    takeProfitLastArmedAt: pos.takeProfitLastArmedAt,
    securityStopLastArmedAt: pos.securityStopLastArmedAt,
    stopLossAbsenceConfirmations: pos.stopLossAbsenceConfirmations,
    takeProfitAbsenceConfirmations: pos.takeProfitAbsenceConfirmations,
    securityStopAbsenceConfirmations: pos.securityStopAbsenceConfirmations,
    securityStopRequired: pos.securityStopRequired,
    securityStopStatus: pos.securityStopStatus,
