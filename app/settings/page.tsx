...
export default function SettingsPage() {
  ...
  const [settings, setSettings] = useState<Settings>({
    ...
    presetBlockMaxStack: initialSettings.presetBlockMaxStack ?? initialSettings.blockMaxStack ?? 6,
    ...
    blockMaxStack: initialSettings.blockMaxStack ?? initialSettings.presetBlockMaxStack ?? 6,
